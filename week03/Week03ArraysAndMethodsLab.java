...
//			}
//		}
//		or if (number % 2 == 1) also prints out odd numbers
...
//		System.out.println(welcome("Valmira"));
//		OR
		String welcomeName = welcome("Valmira");
...
//		The first method has sysout in code that will print. Cannot create string variable.
//		The second method will only return the value of the string. Can create string variable.
		...
		System.out.println(isStringLongerThanNumber("Valmira", 6));
		...
		int[] nameLengths = extractsStringLengths(names);
	...
	// Method 19:
	public static int[] extractsStringLengths (String[] strings) {
